...
enum UsecaseStatus {
    case idle
    case executing(usecase: Domains, file: String, line: Int, function: String, startAt: Date)
...
enum Domains {
    ...
    case application(usecase: Application.Usecases)
    case signIn(usecase: SignIn.Usecases)
    case shopping(usecase: Shopping.Usecases)
}
